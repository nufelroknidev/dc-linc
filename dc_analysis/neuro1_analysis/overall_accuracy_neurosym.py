...
DEFAULT_CSV = Path("/app/linc/dc_analysis/neuro1_analysis/neurosym_predictions.csv")
DEFAULT_JSON = Path("/app/linc/dc_analysis/neuro1_analysis/neurosym_summary.json")
DEFAULT_FIG = Path("/app/linc/dc_analysis/neuro1_analysis/neurosym_confusion_matrix.png")
...
def plot_confusion(references: List[str],
    ...
    ax.set_title("Confusion Matrix (Baseline LINC)")
    fig.tight_layout()
    if save_path:
